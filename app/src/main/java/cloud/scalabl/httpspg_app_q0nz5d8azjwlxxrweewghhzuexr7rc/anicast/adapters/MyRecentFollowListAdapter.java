...
public class MyRecentFollowListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyRecentFollowListAdapter(Context context, RequestManager requestManager) {
