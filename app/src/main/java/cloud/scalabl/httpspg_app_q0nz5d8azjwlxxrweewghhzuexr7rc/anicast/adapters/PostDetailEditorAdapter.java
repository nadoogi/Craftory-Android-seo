...
public class PostDetailEditorAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PostDetailEditorAdapter(AppCompatActivity act, Context context, RequestManager requestManager, ParseObject fundingItemOb) {
    ...
    public PostDetailEditorAdapter(Context context, RequestManager requestManager, ParseObject fundingItemOb) {
