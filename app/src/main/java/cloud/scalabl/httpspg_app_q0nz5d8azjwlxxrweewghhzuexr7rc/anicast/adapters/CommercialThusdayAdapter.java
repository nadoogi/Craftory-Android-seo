...
public class CommercialThusdayAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommercialThusdayAdapter(Context context, RequestManager requestManager) {
        ...
        this.queryFactory = new ParseQueryAdapter.QueryFactory<ParseObject>() {
            ...
            public ParseQuery<ParseObject> create() {
                ...
                query.whereEqualTo("day_array", 3);
                query.include("user");
