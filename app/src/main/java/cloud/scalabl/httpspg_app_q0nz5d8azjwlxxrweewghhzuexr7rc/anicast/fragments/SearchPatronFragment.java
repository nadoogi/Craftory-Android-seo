...
public class SearchPatronFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        searchPatronAdapter = new SearchPatronAdapter( getActivity(), "createdAt", false , query, "channel" , requestManager);

        search_result.setAdapter(searchPatronAdapter);
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if(dy > 0) {
                    ...
                    if ( (visibleItemCount + pastVisibleItems) >= totalItemCount) {
                        searchPatronAdapter.loadNextPage();
                    }
