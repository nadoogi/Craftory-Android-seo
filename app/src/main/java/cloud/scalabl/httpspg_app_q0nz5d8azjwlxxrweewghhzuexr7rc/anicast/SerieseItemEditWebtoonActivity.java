...
public class SerieseItemEditWebtoonActivity extends AppCompatActivity implements FileOpenClickListener, ImageInfoClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seriese_item_add_webtoon);
        ...
        back_button_text.setText("연재 작품 수정");
        ...
        query.getInBackground(postId, new GetCallback<ParseObject>() {
            ...
            public void done(final ParseObject postOb, ParseException e) {
                ...
                if(e==null){
                    ...
                    functionBase.generalImageLoading(represent_image, postOb, requestManager);
                    ...
                    save_button.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            if(savedImages.size() == 0){
                                ...
                                TastyToast.makeText(getApplicationContext(), "대표 이미지가 등록되지 않았습니다. 이미지를 등록하세요", TastyToast.LENGTH_LONG, TastyToast.ERROR);
                                save_button.setClickable(true);
                                ...
                                for(String tagItem : tagString){
                                    ...
                                    if(tagItem.length() != 0){
                                        ...
                                        tagLog.put("place", "seriese_webtoon_edit");
                                ...
                                params.put("lastAction", "webtoonEditFromSerise");
                                params.put("image_array", savedImages);
                                params.put("postId", postOb.getObjectId());
                                params.put("parentId", postOb.getParseObject("seriese_parent").getObjectId());

                                ParseCloud.callFunctionInBackground("seriese_webtoon_save", params, new FunctionCallback<Map<String, Object>>() {
                    ...
                    imageAdapter = new ImageUploadSelector2Adapter(getApplicationContext(), savedImages, requestManager, illust_status_text);
                    imageAdapter.setFileOpenClickListener(SerieseItemEditWebtoonActivity.this);
                    imageAdapter.setImageInfoClickListener(SerieseItemEditWebtoonActivity.this);
