...
public class ArtistWebtoonPostAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ArtistWebtoonPostAdapter(Context context, RequestManager requestManager) {

        ArtistWebtoonPostAdapter.requestManager = requestManager;
        ArtistWebtoonPostAdapter.context = context;
