...
import cloud.scalabl.httpspg_app_q0nz5d8azjwlxxrweewghhzuexr7rc.anicast.adapters.LibrarySubsAdapter;
...
public class LibrarySubscribeFragment extends Fragment {
    ...
    LibrarySubsAdapter librarySubsAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_library_subs, container, false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        swipeLayout.setOnRefreshListener(new PullRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                librarySubsAdapter.loadObjects(0);
        ...
        librarySubsAdapter = new LibrarySubsAdapter(getActivity(), requestManager, type);

        library_list.setItemAnimator(new SlideInUpAnimator());
        library_list.setAdapter(librarySubsAdapter);
        ...
        library_list.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if(dy > 0) //check for scroll down
                {
                    ...
                    {
                        librarySubsAdapter.loadNextPage();
                    }
