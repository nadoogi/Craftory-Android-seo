...
import cloud.scalabl.httpspg_app_q0nz5d8azjwlxxrweewghhzuexr7rc.anicast.adapters.ArtistNovelAdapter;
...
public class ArtistNovelSerieseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_artist_novel_seriese, container, false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView seriese_list = (RecyclerView) view.findViewById(R.id.seriese_list);

        final GridLayoutManager layoutManager;

        layoutManager = new GridLayoutManager(getActivity(),1);

        seriese_list.setLayoutManager(layoutManager);
        //seriese_list.setHasFixedSize(true);
        seriese_list.setNestedScrollingEnabled(false);

        ArtistNovelAdapter artistNovelAdapter = new ArtistNovelAdapter(getActivity(), requestManager);

        seriese_list.setAdapter(artistNovelAdapter);
