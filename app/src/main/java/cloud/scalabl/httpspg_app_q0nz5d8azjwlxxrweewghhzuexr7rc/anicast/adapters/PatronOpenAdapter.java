...
public class PatronOpenAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PatronOpenAdapter(Context context, RequestManager requestManager) {
