...
public class ContentRecentAdapter extends RecyclerParseAdapter {
    ...
    public ContentRecentAdapter(Context context, RequestManager requestManager){
        super(context);
        ...
        this.queryFactory = new ParseQueryAdapter.QueryFactory<ParseObject>() {
            ...
            public ParseQuery<ParseObject> create() {
                ...
                query.orderByDescending(functionBase.recentFilter);
