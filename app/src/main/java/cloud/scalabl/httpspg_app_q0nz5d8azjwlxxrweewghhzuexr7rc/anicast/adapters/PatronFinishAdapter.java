...
public class PatronFinishAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PatronFinishAdapter(Context context, RequestManager requestManager, final String type) {
