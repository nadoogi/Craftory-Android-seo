...
public class SearchSerieseAdapter extends RecyclerParseAdapter {
    ...
    public SearchSerieseAdapter(Context context, final String orderBy, final Boolean ascending, final String queryString, String type, RequestManager requestManager) {
        ...
        this.queryFactory = new ParseQueryAdapter.QueryFactory<ParseObject>() {
            ...
            public ParseQuery<ParseObject> create() {
                ...
                if(queryString != null || queryString.length() == 0){
                    ...
                    nameQuery.whereEqualTo("post_type", "seriese");
