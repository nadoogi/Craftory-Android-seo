...
/**
 * Created by ssamkyu on 2017. 5. 1..
 */

public class HorizonRecentAdapter extends RecyclerParseAdapter {
    ...
    public HorizonRecentAdapter(Context context, final String orderBy, final Boolean ascending, RequestManager requestManager) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        listView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_card_small, parent, false);

        return new ContentViewHolder(listView);
