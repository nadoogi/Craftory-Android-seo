...
public class CommercialFridayAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommercialFridayAdapter(Context context, RequestManager requestManager) {
        ...
        this.queryFactory = new ParseQueryAdapter.QueryFactory<ParseObject>() {
            ...
            public ParseQuery<ParseObject> create() {
                ...
                query.whereEqualTo("day_array", 4);
                query.include("user");
