...
public class UserPostAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public UserPostAdapter(Context context, RequestManager requestManager, final ParseObject userOb) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        timelineView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_user_artwork, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        functionPost.UserPostBuilder( timelineOb,  holder, requestManager, "cm" , this );
