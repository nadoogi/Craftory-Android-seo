...
import cloud.scalabl.httpspg_app_q0nz5d8azjwlxxrweewghhzuexr7rc.anicast.adapters.CommercialFinishAdapter;
...
public class ArtworkFinishFragment extends Fragment {

    private static CommercialFinishAdapter commercialFinishAdapter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        commercialFinishAdapter = new CommercialFinishAdapter(getActivity(), requestManager);
        tues_list.setAdapter(commercialFinishAdapter);
                ...
                if(dy > 0) //check for scroll down
                {
                    ...
                    if(loading){
                        ...
                        if ( (visibleItemCount + pastVisibleItems) >= totalItemCount) {
                            ...
                            commercialFinishAdapter.loadNextPage();
