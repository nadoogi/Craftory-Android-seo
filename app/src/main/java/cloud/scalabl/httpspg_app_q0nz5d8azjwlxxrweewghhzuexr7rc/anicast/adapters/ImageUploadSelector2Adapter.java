...
public class ImageUploadSelector2Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ImageUploadSelector2Adapter(Context context, ArrayList<HashMap<String, String>> images, RequestManager requestManager, TextView status_text) {
