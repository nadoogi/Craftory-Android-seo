...
public class FundingMarketDealerItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FundingMarketDealerItemAdapter(Context context, RequestManager requestManager, final ParseObject dealerOb) {
