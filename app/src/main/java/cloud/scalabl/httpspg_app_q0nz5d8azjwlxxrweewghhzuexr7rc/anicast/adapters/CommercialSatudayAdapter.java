...
public class CommercialSatudayAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommercialSatudayAdapter(Context context, RequestManager requestManager) {
        ...
        final ArrayList<Integer> queryArray = new ArrayList<>();
        queryArray.add(0);
        ...
        this.queryFactory = new ParseQueryAdapter.QueryFactory<ParseObject>() {
            ...
            public ParseQuery<ParseObject> create() {
                ...
                query.whereEqualTo("day_array", 5);
                query.include("user");
