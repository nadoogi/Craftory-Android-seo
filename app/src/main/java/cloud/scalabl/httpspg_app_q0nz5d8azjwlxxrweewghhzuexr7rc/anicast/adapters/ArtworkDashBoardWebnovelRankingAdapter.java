...
import cloud.scalabl.httpspg_app_q0nz5d8azjwlxxrweewghhzuexr7rc.anicast.viewHolders.ArtworkDashboardWebnovelRankingViewHolder;
...
public class ArtworkDashBoardWebnovelRankingAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ArtworkDashBoardWebnovelRankingAdapter(Context context, RequestManager requestManager) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_artwork_webnovel_ranking, parent, false);

        return new ArtworkDashboardWebnovelRankingViewHolder(itemView);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        ImageView seriese_image = ((ArtworkDashboardWebnovelRankingViewHolder)holder).getSerieseImage();
        TextView nickname  = ((ArtworkDashboardWebnovelRankingViewHolder)holder).getNickname();
        TextView title = ((ArtworkDashboardWebnovelRankingViewHolder)holder).getTitle();
        TextView description = ((ArtworkDashboardWebnovelRankingViewHolder)holder).getDescription();
        LinearLayout profile_tag  = ((ArtworkDashboardWebnovelRankingViewHolder)holder).getProfileTag();
        ...
        description.setText(postOb.getString("body"));
