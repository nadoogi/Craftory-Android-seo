...
public class MyRecommendPatronFragment extends Fragment {

    public static RecommentPatronAdapter recommentPatronAdapter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        swipeLayout.setOnRefreshListener(new PullRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                recommentPatronAdapter.loadObjects(0);
        ...
        recommentPatronAdapter = new RecommentPatronAdapter(getActivity(), requestManager);

        new_content_list.setItemAnimator(new SlideInUpAnimator());
        new_content_list.setAdapter(recommentPatronAdapter);
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if(dy > 0) //check for scroll down
                {
                    ...
                    if ( (visibleItemCount + pastVisibleItems) >= totalItemCount) {
                        ...
                        if(recommentPatronAdapter.getItemCount() > 20){

                            recommentPatronAdapter.loadNextPage();
