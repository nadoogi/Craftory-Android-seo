...
public class LibraryPurchaseAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public LibraryPurchaseAdapter(Context context, RequestManager requestManager, final String type) {
        ...
        this.currentPage = 0;
        final ParseObject pointOb = currentUser.getParseObject("point");

        Log.d("LibraryPurchaseAdapter", pointOb.getObjectId());

        this.queryFactory = new ParseQueryAdapter.QueryFactory<ParseObject>() {
            @Override
            public ParseQuery<ParseObject> create() {

                ParseQuery<ParseObject> query = pointOb.getRelation("purchase_item").getQuery();
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        ParseObject postOb = timelineOb.getParseObject("artist_post");

        FunctionPost functionPost = new FunctionPost(context);
        functionPost.TimelineArtistPostAdapterBuilder( postOb, holder, requestManager, "cm");
