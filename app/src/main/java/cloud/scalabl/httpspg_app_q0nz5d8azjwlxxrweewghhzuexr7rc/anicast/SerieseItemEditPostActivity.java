...
public class SerieseItemEditPostActivity extends AppCompatActivity {
        ...
        query.getInBackground(postId, new GetCallback<ParseObject>() {
            ...
            public void done(final ParseObject postOb, ParseException e) {
                ...
                if(e==null){
                    ...
                    functionBase.generalImageLoading(preview, postOb, requestManager);
                            ...
                            if(finalImage == null){
                                ...
                                for(String tagItem : tagString){
                                    ...
                                    if(tagItem.length() != 0){
                                        ...
                                        tagLog.put("place", "seriese_post_edit");
                                ...
                                params.put("lastAction", "postEditFromSerise");
