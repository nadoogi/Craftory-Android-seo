...
public class GoodsFundingEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_button_text.setText("굿즈펀딩 수정하기");
        ...
        postQuery.getInBackground(postId, new GetCallback<ParseObject>() {
            ...
            public void done(ParseObject postOb, ParseException e) {
                ...
                if(e==null){
                    ...
                    price.setText( String.valueOf(postObject.getInt("price")) );
                    tagString = functionBase.jsonArrayToArrayList(postObject.getJSONArray("tag_array"));
                    tagGroup.setTags(tagString);
                    itemObject = postObject.getParseObject("item");

                    endDate = postObject.getDate("endDate");
                    selected_date.setText( functionBase.dateToString(postObject.getDate("endDate")) );

                    target_head_count.setText(String.valueOf(postOb.getInt("target_amount")));

                    finalImage = postObject.getString("image_cdn");
                    functionBase.generalImageLoading(represent_image, postObject, requestManager);
