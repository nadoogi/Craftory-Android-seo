...
public class PostCSParseQueryAdapter extends RecyclerParseAdapter {
    ...
    public PostCSParseQueryAdapter(Context context, RequestManager requestManager){
        super(context);
