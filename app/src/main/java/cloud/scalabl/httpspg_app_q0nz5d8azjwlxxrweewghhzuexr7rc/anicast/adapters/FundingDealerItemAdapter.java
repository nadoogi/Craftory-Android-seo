...
public class FundingDealerItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FundingDealerItemAdapter(Context context, RequestManager requestManager, final ParseObject dealerOb ) {
        ...
        this.queryFactory = new ParseQueryAdapter.QueryFactory<ParseObject>() {
            ...
            public ParseQuery<ParseObject> create() {
                ...
                query.whereNotEqualTo("objectId", dealerOb.getObjectId());
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_funding_sales_item2, parent, false);
