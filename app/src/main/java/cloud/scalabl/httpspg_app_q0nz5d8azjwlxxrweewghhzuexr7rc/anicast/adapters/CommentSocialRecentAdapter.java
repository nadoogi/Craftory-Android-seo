...
public class CommentSocialRecentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommentSocialRecentAdapter(Context context, RequestManager requestManager, ParseObject parentOb) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        functionComment.CommentRecentAdapterBuilder(commentOb, holder, parentObject, this, "social", requestManager);
