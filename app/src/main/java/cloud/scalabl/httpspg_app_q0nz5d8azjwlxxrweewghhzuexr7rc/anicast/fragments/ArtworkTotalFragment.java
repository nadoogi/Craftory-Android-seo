...
import cloud.scalabl.httpspg_app_q0nz5d8azjwlxxrweewghhzuexr7rc.anicast.adapters.CommercialTotalAdapter;
...
public class ArtworkTotalFragment extends Fragment {

    private static CommercialTotalAdapter commercialTotalAdapter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        commercialTotalAdapter = new CommercialTotalAdapter(getActivity(), requestManager);
        tues_list.setAdapter(commercialTotalAdapter);
                ...
                if(dy > 0) //check for scroll down
                {
                    ...
                    if(loading){
                        ...
                        if ( (visibleItemCount + pastVisibleItems) >= totalItemCount) {
                            ...
                            commercialTotalAdapter.loadNextPage();
