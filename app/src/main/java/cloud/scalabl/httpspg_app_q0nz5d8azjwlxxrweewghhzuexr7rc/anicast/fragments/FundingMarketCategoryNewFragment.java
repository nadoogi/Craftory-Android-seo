...
import cloud.scalabl.httpspg_app_q0nz5d8azjwlxxrweewghhzuexr7rc.anicast.adapters.FundingMarketCategoryNewItemAdapter;
import cloud.scalabl.httpspg_app_q0nz5d8azjwlxxrweewghhzuexr7rc.anicast.adapters.FundingMarketDealerItemAdapter;
import cloud.scalabl.httpspg_app_q0nz5d8azjwlxxrweewghhzuexr7rc.anicast.adapters.FundingMarketDealerNewItemAdapter;
...
public class FundingMarketCategoryNewFragment extends Fragment {
    ...
    private FundingMarketCategoryNewItemAdapter fundingMarketCategoryItemAdapter;
    private FundingMarketDealerNewItemAdapter fundingMarketDealerNewItemAdapter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if(category == null){
            ...
            query.getInBackground(dealerId, new GetCallback<ParseObject>() {
                ...
                public void done(ParseObject dealerOb, ParseException e) {
                    ...
                    if(e==null){
                        ...
                        fundingMarketDealerNewItemAdapter = new FundingMarketDealerNewItemAdapter(getActivity(), requestManager, dealerOb);

                        market_list.setItemAnimator(new SlideInUpAnimator());
                        market_list.setAdapter(fundingMarketDealerNewItemAdapter);
                            ...
                            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                                ...
                                if(dy > 0) {
                                    ...
                                    if ( (visibleItemCount + pastVisibleItems) >= totalItemCount) {
                                        ...
                                        fundingMarketDealerNewItemAdapter.loadNextPage();
            ...
            fundingMarketCategoryItemAdapter = new FundingMarketCategoryNewItemAdapter(getActivity(), requestManager,  category);
    ...
    public void onResume() {
        ...
        if(fundingMarketDealerNewItemAdapter != null){

            fundingMarketDealerNewItemAdapter.loadObjects(0);
        }
