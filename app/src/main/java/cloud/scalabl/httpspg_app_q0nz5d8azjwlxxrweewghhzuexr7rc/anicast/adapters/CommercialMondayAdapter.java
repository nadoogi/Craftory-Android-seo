...
public class CommercialMondayAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommercialMondayAdapter(Context context, RequestManager requestManager) {
        ...
        this.queryFactory = new ParseQueryAdapter.QueryFactory<ParseObject>() {
            ...
            public ParseQuery<ParseObject> create() {
                ...
                query.whereEqualTo("day_array", 0);
                query.include("user");
