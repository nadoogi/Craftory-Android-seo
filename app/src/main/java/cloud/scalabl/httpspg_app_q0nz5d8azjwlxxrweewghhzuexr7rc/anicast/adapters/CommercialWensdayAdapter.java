...
public class CommercialWensdayAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommercialWensdayAdapter(Context context, RequestManager requestManager) {
        ...
        this.queryFactory = new ParseQueryAdapter.QueryFactory<ParseObject>() {
            ...
            public ParseQuery<ParseObject> create() {
                ...
                query.whereEqualTo("day_array", 2);
                query.include("user");
