...
public class PatronNewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PatronNewAdapter(Context context, RequestManager requestManager) {
        ...
        this.queryFactory = new ParseQueryAdapter.QueryFactory<ParseObject>() {
            ...
            public ParseQuery<ParseObject> create() {
                ...
                query.whereEqualTo("progress","start");
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(timelineOb.getString("content_type").equals("goods")){
            ...
            timelineView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_timeline_patron4, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if(timelineOb.getString("content_type").equals("goods")){
            ...
            functionPost.TimelineArtistPatronForGoodAdapterBuilder(timelineOb, holder, requestManager, "all");
