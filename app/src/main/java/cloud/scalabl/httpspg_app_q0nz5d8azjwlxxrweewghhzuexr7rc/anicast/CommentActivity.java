...
import cloud.scalabl.httpspg_app_q0nz5d8azjwlxxrweewghhzuexr7rc.anicast.fragments.CommentBestFragment;
import cloud.scalabl.httpspg_app_q0nz5d8azjwlxxrweewghhzuexr7rc.anicast.fragments.CommentRecentFragment;
            ...
            public Fragment getItem(int position) {
                ...
                switch (position) {
                    ...
                    case 0:
                        ...
                        commentRecentFragment.setArguments(recentBundle);


                        return commentRecentFragment;

                    case 1:

                        Bundle bestBundle = new Bundle();
                        bestBundle.putString("parentId", contentId);
                        commentBestFragment.setArguments(bestBundle);

                        return commentBestFragment;
