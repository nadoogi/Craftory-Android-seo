...
import cloud.scalabl.httpspg_app_q0nz5d8azjwlxxrweewghhzuexr7rc.anicast.adapters.CommercialSundayAdapter;
...
public class ArtworkSundayFragment extends Fragment {

    private static CommercialSundayAdapter commercialSundayAdapter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        commercialSundayAdapter = new CommercialSundayAdapter(getActivity(), requestManager);
        tues_list.setAdapter(commercialSundayAdapter);
                ...
                if(dy > 0) //check for scroll down
                {
                    ...
                    if(loading){
                        ...
                        if ( (visibleItemCount + pastVisibleItems) >= totalItemCount) {
                            ...
                            commercialSundayAdapter.loadNextPage();
