...
import cloud.scalabl.httpspg_app_q0nz5d8azjwlxxrweewghhzuexr7rc.anicast.adapters.MyRecentFollowerAdapter;
...
public class MyContentFollowerFragment extends Fragment {

    int pastVisibleItems, visibleItemCount, totalItemCount;

    private MyRecentFollowerAdapter myRecentFollowerAdapter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        swipeLayout.setOnRefreshListener(new PullRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                myRecentFollowerAdapter.loadObjects(0);
        ...
        if(currentUser != null){
            ...
            myRecentFollowerAdapter = new MyRecentFollowerAdapter(getActivity(), requestManager);

            my_content_list.setItemAnimator(new SlideInUpAnimator());
            my_content_list.setAdapter(myRecentFollowerAdapter);
                ...
                public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                    ...
                    if(dy > 0){
                        ...
                        if ( (visibleItemCount + pastVisibleItems) >= totalItemCount) {
                            myRecentFollowerAdapter.loadNextPage();
                        }
