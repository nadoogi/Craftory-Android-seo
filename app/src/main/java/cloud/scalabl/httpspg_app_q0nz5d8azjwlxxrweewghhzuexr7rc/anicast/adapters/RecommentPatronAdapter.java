...
public class RecommentPatronAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecommentPatronAdapter(Context context, RequestManager requestManager) {
