...
public class MyContentFollowAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyContentFollowAdapter(Context context, RequestManager requestManager) {
