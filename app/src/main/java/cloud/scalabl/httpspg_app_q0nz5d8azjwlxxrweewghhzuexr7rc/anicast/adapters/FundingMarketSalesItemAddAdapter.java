...
import cloud.scalabl.httpspg_app_q0nz5d8azjwlxxrweewghhzuexr7rc.anicast.FundingMarketSalesItemEditorActivity;
...
public class FundingMarketSalesItemAddAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FundingMarketSalesItemAddAdapter(Context context, RequestManager requestManager, ParseObject dealerOb) {
        ...
        this.queryFactory = new ParseQueryAdapter.QueryFactory<ParseObject>() {
            ...
            public ParseQuery<ParseObject> create() {
                ...
                query.whereEqualTo("dealer", dealerObject);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        final ParseObject dealerOb = itemOb.getParseObject("dealer");
        ...
        LinearLayout layout = ((FundingMarketItemHolder)holder).getPostImageLayout();
        ...
        layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, FundingMarketSalesItemEditorActivity.class);
