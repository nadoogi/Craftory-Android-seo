...
public class RecommendCraftorAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecommendCraftorAdapter(Context context, RequestManager requestManager) {
        ...
        if(currentUser != null){
            ...
            this.queryFactory = new ParseQueryAdapter.QueryFactory<ParseObject>() {
                ...
                public ParseQuery<ParseObject> create() {
                    ...
                    query.whereContainedIn("tags", queryList);
