...
public class PostEditWebtoonActivity extends AppCompatActivity implements FileOpenClickListener, ImageInfoClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_edit_webtoon);
        ...
        back_button_text.setText("웹툰 수정하기");
        ...
        postQury.getInBackground(postId, new GetCallback<ArtistPost>() {
            ...
            public void done(ArtistPost postOb, ParseException e) {
                ...
                if(e==null){
                    ...
                    save_button.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            if(savedImages.size() == 0){
                                ...
                                params.put("lastAction", "webtoonEdit");
                    ...
                    imageAdapter.setFileOpenClickListener(PostEditWebtoonActivity.this);
                    imageAdapter.setImageInfoClickListener(PostEditWebtoonActivity.this);
    ...
    public void onImageInfoOpened(HashMap<String, String> data) {
        ...
        final MaterialDialog imageDialog = new MaterialDialog.Builder(PostEditWebtoonActivity.this)
                .title("이미지 정보")
