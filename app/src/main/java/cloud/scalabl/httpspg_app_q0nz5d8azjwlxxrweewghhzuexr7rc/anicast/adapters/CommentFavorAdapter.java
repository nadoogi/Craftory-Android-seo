...
public class CommentFavorAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommentFavorAdapter(Context context, RequestManager requestManager, ParseObject parentOb) {

        CommentFavorAdapter.requestManager = requestManager;
        CommentFavorAdapter.context = context;
