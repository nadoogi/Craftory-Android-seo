...
public class TagTimelineFavorFragment extends Fragment {

    private RecyclerView new_content_list;
    int pastVisibleItems, visibleItemCount, totalItemCount;
    private TagTimelineFavorAdapter tagTimelineFavorAdapter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        swipeLayout.setOnRefreshListener(new PullRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                tagTimelineFavorAdapter = new TagTimelineFavorAdapter(getActivity(), requestManager, functionBase, functionPost, tagString);
                new_content_list.setAdapter(tagTimelineFavorAdapter);
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if(dy > 0) //check for scroll down
                {
                    ...
                    if ( (visibleItemCount + pastVisibleItems) >= totalItemCount) {
                        ...
                        if(tagTimelineFavorAdapter.getItemCount() >20){

                            tagTimelineFavorAdapter.loadNextPage();
    ...
    public void onResume() {
        ...
        if(tagTimelineFavorAdapter != null){

            tagTimelineFavorAdapter.notifyDataSetChanged();
