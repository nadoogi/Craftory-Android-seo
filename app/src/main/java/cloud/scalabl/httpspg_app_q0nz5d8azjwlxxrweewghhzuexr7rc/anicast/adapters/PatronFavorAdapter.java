...
public class PatronFavorAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PatronFavorAdapter(Context context, RequestManager requestManager) {
