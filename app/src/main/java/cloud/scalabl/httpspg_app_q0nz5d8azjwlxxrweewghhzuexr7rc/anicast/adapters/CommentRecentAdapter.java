...
public class CommentRecentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommentRecentAdapter(Context context, RequestManager requestManager, ParseObject parentOb) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        functionComment.CommentRecentAdapterBuilder(commentOb, holder, parentObject, this, "comment", requestManager);
