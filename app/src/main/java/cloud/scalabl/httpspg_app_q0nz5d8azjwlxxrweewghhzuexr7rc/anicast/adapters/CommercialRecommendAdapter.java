...
public class CommercialRecommendAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommercialRecommendAdapter(Context context, RequestManager requestManager, final ParseObject parentOb ) {
