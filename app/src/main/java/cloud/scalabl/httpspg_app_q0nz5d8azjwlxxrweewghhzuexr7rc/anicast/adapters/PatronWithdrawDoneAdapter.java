...
public class PatronWithdrawDoneAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PatronWithdrawDoneAdapter(Context context, RequestManager requestManager, final String type) {
        ...
        this.queryFactory = new ParseQueryAdapter.QueryFactory<ParseObject>() {
            ...
            public ParseQuery<ParseObject> create() {
                ...
                query.whereEqualTo("progress", type);
