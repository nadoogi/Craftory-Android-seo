...
public class FundingMarketCategoryNewItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FundingMarketCategoryNewItemAdapter(Context context, RequestManager requestManager,  String category) {
