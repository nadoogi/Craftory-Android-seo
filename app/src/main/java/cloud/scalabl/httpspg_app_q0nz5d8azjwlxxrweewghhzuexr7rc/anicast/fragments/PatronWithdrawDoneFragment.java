...
import cloud.scalabl.httpspg_app_q0nz5d8azjwlxxrweewghhzuexr7rc.anicast.adapters.PatronWithdrawDoneAdapter;
...
public class PatronWithdrawDoneFragment extends Fragment {

    private RecyclerView new_content_list;
    private RequestManager requestManager;
    public PatronWithdrawDoneAdapter patronWithdrawDoneAdapter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        swipeLayout.setOnRefreshListener(new PullRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                patronWithdrawDoneAdapter =  new PatronWithdrawDoneAdapter(getActivity(), requestManager ,"withdraw_done");
                new_content_list.setAdapter(patronWithdrawDoneAdapter);
                ...
                if(dy > 0) {
                    ...
                    if(loading){
                        ...
                        if ( (visibleItemCount + pastVisibleItems) >= totalItemCount) {
                            ...
                            patronWithdrawDoneAdapter.loadNextPage();
        ...
        patronWithdrawDoneAdapter.addOnQueryLoadListener(new PatronWithdrawDoneAdapter.OnQueryLoadListener<ParseObject>() {
            @Override
    ...
    public void onResume() {
        ...
        if(patronWithdrawDoneAdapter != null){

            patronWithdrawDoneAdapter.loadObjects(0);
