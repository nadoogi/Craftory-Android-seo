...
public class HorizonFavorAdapter extends RecyclerParseAdapter {
    ...
    public HorizonFavorAdapter(Context context, final String orderBy, final Boolean ascending, RequestManager requestManager) {
