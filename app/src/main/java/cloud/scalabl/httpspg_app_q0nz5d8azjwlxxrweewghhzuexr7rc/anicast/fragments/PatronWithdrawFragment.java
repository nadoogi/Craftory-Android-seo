...
import cloud.scalabl.httpspg_app_q0nz5d8azjwlxxrweewghhzuexr7rc.anicast.adapters.PatronWithdrawAdapter;
...
public class PatronWithdrawFragment extends Fragment {

    private RecyclerView new_content_list;
    private RequestManager requestManager;
    public PatronWithdrawAdapter patronWithdrawAdapter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        swipeLayout.setOnRefreshListener(new PullRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                patronWithdrawAdapter =  new PatronWithdrawAdapter(getActivity(), requestManager, "withdraw");
                new_content_list.setAdapter(patronWithdrawAdapter);
                ...
                if(dy > 0) {
                    ...
                    if(loading){
                        ...
                        if ( (visibleItemCount + pastVisibleItems) >= totalItemCount) {
                            ...
                            patronWithdrawAdapter.loadNextPage();
    ...
    public void onResume() {
        ...
        if(patronWithdrawAdapter != null){

            patronWithdrawAdapter.loadObjects(0);
