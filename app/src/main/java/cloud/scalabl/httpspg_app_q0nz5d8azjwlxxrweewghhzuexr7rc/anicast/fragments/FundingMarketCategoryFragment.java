...
public class FundingMarketCategoryFragment extends Fragment {
    ...
    private FundingMarketCategoryItemAdapter fundingMarketCategoryItemAdapter;
    private FundingMarketDealerItemAdapter fundingMarketDealerItemAdapter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if(category == null){
            ...
            query.getInBackground(dealerId, new GetCallback<ParseObject>() {
                ...
                public void done(ParseObject dealerOb, ParseException e) {
                    ...
                    if(e==null){
                        ...
                        market_list.setAdapter(fundingMarketDealerItemAdapter);
                            ...
                            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                                ...
                                if(dy > 0) {
                                    ...
                                    if ( (visibleItemCount + pastVisibleItems) >= totalItemCount) {
                                        ...
                                        fundingMarketDealerItemAdapter.loadNextPage();
            ...
            fundingMarketCategoryItemAdapter = new FundingMarketCategoryItemAdapter(getActivity(), requestManager,  category);
            market_list.setItemAnimator(new SlideInUpAnimator());
    ...
    public void onResume() {
        ...
        if(fundingMarketDealerItemAdapter != null){

            fundingMarketDealerItemAdapter.loadObjects(0);
        }
