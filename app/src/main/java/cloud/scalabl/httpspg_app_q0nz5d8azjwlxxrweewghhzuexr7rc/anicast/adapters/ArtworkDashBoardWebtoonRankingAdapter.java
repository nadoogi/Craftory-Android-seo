...
import cloud.scalabl.httpspg_app_q0nz5d8azjwlxxrweewghhzuexr7rc.anicast.viewHolders.ArtworkDashboardWebtoonRankingViewHolder;
...
public class ArtworkDashBoardWebtoonRankingAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ArtworkDashBoardWebtoonRankingAdapter(Context context, RequestManager requestManager) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_artwork_webtoon_ranking, parent, false);

        return new ArtworkDashboardWebtoonRankingViewHolder(itemView);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        ImageView seriese_image = ((ArtworkDashboardWebtoonRankingViewHolder)holder).getSerieseImage();
        TextView nickname  = ((ArtworkDashboardWebtoonRankingViewHolder)holder).getNickname();
        TextView title = ((ArtworkDashboardWebtoonRankingViewHolder)holder).getTitle();
        LinearLayout profile_tag  = ((ArtworkDashboardWebtoonRankingViewHolder)holder).getProfileTag();
        LinearLayout post_tag_layout = ((ArtworkDashboardWebtoonRankingViewHolder)holder).getPostTagGroup();
        TagGroup tagGroup = ((ArtworkDashboardWebtoonRankingViewHolder)holder).getTagGroup();
        ...
        JSONArray tagArray = postOb.getJSONArray("tag_array");
