...
public class FundingMarketCategoryItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FundingMarketCategoryItemAdapter(Context context, RequestManager requestManager, String category) {
