...
public class MyRecentFollowerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyRecentFollowerAdapter(Context context, RequestManager requestManager) {
