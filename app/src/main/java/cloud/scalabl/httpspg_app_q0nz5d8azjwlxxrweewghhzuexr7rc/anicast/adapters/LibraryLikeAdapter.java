...
public class LibraryLikeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public LibraryLikeAdapter(Context context, RequestManager requestManager, final String type) {
