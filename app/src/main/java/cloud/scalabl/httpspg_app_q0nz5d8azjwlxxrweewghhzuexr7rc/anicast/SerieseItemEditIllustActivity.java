...
public class SerieseItemEditIllustActivity extends AppCompatActivity implements FileOpenClickListener, ImageInfoClickListener {
        ...
        query.getInBackground(postId, new GetCallback<ParseObject>() {
            ...
            public void done(final ParseObject postOb, ParseException e) {
                ...
                if(e==null){
                    ...
                    save_button.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            if(images.size() == 0){
                                ...
                                params.put("lastAction", "albumEditFromSerise");
                    ...
                    imageAdapter.setFileOpenClickListener(SerieseItemEditIllustActivity.this);
                    imageAdapter.setImageInfoClickListener(SerieseItemEditIllustActivity.this);
