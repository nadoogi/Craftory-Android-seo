...
import cloud.scalabl.httpspg_app_q0nz5d8azjwlxxrweewghhzuexr7rc.anicast.adapters.PatronFavorAdapter;
...
public class PatronFavorFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        swipeLayout.setOnRefreshListener(new PullRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                patronFavorAdapter = new PatronFavorAdapter(getActivity(), requestManager);
                new_content_list.setAdapter(patronFavorAdapter);
                ...
                if(dy > 0) {
                    ...
                    if(loading){
                        ...
                        if ( (visibleItemCount + pastVisibleItems) >= totalItemCount) {
                            ...
                            patronFavorAdapter.loadNextPage();
        ...
        patronFavorAdapter.addOnQueryLoadListener(new PatronFavorAdapter.OnQueryLoadListener<ParseObject>() {
            @Override
    ...
    public void onResume() {
        ...
        if(patronFavorAdapter != null){

            patronFavorAdapter.loadObjects(0);
