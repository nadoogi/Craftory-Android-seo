...
public class DealerTimelineAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public DealerTimelineAdapter(Context context, RequestManager requestManager, FunctionBase functionBase, FunctionPost functionPost, final String dealerId) {
        ...
        this.queryFactory = new ParseQueryAdapter.QueryFactory<ParseObject>() {
            ...
            public ParseQuery<ParseObject> create() {
                ...
                query.whereEqualTo("dealerId", dealerId);
