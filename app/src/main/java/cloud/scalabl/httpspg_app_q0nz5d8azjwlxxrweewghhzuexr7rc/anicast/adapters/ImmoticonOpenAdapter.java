...
public class ImmoticonOpenAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ImmoticonOpenAdapter(Context context, RequestManager requestManager) {
