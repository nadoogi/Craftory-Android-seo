...
public class CommercialTotalAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommercialTotalAdapter(Context context, RequestManager requestManager) {
