...
import cloud.scalabl.httpspg_app_q0nz5d8azjwlxxrweewghhzuexr7rc.anicast.adapters.CommercialSatudayAdapter;
...
public class ArtworkSatudayFragment extends Fragment {

    private static CommercialSatudayAdapter commercialSatudayAdapter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        commercialSatudayAdapter = new CommercialSatudayAdapter(getActivity(), requestManager);
        tues_list.setAdapter(commercialSatudayAdapter);
                ...
                if(dy > 0) //check for scroll down
                {
                    ...
                    if(loading){
                        ...
                        if ( (visibleItemCount + pastVisibleItems) >= totalItemCount) {
                            ...
                            commercialSatudayAdapter.loadNextPage();
