...
public class ArtistNovelPostAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ArtistNovelPostAdapter(Context context, RequestManager requestManager) {

        ArtistNovelPostAdapter.requestManager = requestManager;
        ArtistNovelPostAdapter.context = context;
