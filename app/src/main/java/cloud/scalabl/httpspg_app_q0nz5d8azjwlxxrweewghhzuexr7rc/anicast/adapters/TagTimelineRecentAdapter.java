...
public class TagTimelineRecentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ArrayList<String> queryTag;



    public TagTimelineRecentAdapter(Context context, RequestManager requestManager, FunctionBase functionBase, FunctionPost functionPost, ArrayList<String> tag) {
