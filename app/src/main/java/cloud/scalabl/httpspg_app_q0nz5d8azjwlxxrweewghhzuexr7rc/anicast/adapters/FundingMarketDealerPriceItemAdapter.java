...
public class FundingMarketDealerPriceItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FundingMarketDealerPriceItemAdapter(Context context, RequestManager requestManager, final ParseObject dealerOb) {
        ...
        this.queryFactory = new ParseQueryAdapter.QueryFactory<ParseObject>() {
            ...
            public ParseQuery<ParseObject> create() {
                ...
                query.whereEqualTo("dealer", dealerOb);
