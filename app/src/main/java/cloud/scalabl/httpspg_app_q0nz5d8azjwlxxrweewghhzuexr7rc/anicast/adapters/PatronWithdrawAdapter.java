...
public class PatronWithdrawAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PatronWithdrawAdapter(Context context, RequestManager requestManager, final String type) {
