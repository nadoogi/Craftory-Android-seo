...
public class SerieseItemAddWebtoonActivity extends AppCompatActivity implements FileOpenClickListener, ImageInfoClickListener {
        ...
        query.getInBackground(serieseId, new GetCallback<ParseObject>() {
            ...
            public void done(final ParseObject parentOb, ParseException e) {
                ...
                if(e==null){
                            ...
                            if(savedImages.size() == 0){
                                ...
                                for(String tagItem : tagString){
                                    ...
                                    if(tagItem.length() != 0){
                                        ...
                                        tagLog.put("place", "seriese_webtoon");
                                ...
                                params.put("lastAction", "webtoonSaveFromSerise");
                    ...
                    imageAdapter.setFileOpenClickListener(SerieseItemAddWebtoonActivity.this);
                ...
                UploadCallback callback = new UploadCallback() {
                    ...
                    public void onSuccess(String requestId, Map resultData) {
                        ...
                        if(imageAdapter != null){
                            ...
                            imageAdapter = new ImageUploadSelector2Adapter(getApplicationContext(), savedImages, requestManager, illust_status_text);
                            imageAdapter.setFileOpenClickListener(SerieseItemAddWebtoonActivity.this);
                            imageAdapter.setImageInfoClickListener(SerieseItemAddWebtoonActivity.this);
                            image_list.setAdapter(imageAdapter);
