...
public class PatronDetailEditorActivity extends AppCompatActivity implements FundingItemDetailEditListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeLayout.setOnRefreshListener(new PullRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                fundingMarketItemEditorAdapter = new FundingMarketItemEditorAdapter( PatronDetailEditorActivity.this,  getApplicationContext(), requestManager, itemObject);
                fundingMarketItemEditorAdapter.setEditListener(PatronDetailEditorActivity.this);
        ...
        query.getInBackground(itemId, new GetCallback<ParseObject>() {
            ...
            public void done(final ParseObject itemOb, ParseException e) {
                ...
                if(e== null){
                    ...
                    fundingMarketItemEditorAdapter = new FundingMarketItemEditorAdapter( PatronDetailEditorActivity.this,  getApplicationContext(), requestManager, itemOb);
                    fundingMarketItemEditorAdapter.setEditListener(PatronDetailEditorActivity.this);
                    ...
                    send_button.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            info_input.setText("");
                            functionBase.hideKeyboard(PatronDetailEditorActivity.this);
                            ...
                            if(editMode){
                                ...
                                final ParseObject postDetailOb = new ParseObject("PostDetail");
                                postDetailOb.put("order", order);
                                postDetailOb.put("content", inputString);
                                postDetailOb.put("type", "String");
                                postDetailOb.put("item", itemOb);
                                postDetailOb.put("status", true);
                                postDetailOb.saveInBackground(new SaveCallback() {
                                    @Override
                                    public void done(ParseException e) {
                                        ...
                                        if(e==null){
                                            ...
                                            infoContentRelationOb.add(postDetailOb);
            ...
            UploadCallback callback = new UploadCallback() {
                ...
                public void onSuccess(String requestId, Map resultData) {
                    ...
                    if(editMode){
                        ...
                        final ParseObject postDetailOb = new ParseObject("PostDetail");
                        postDetailOb.put("order", order);
                        postDetailOb.put("content", uploadTarget);
                        postDetailOb.put("type", "Image");
                        postDetailOb.put("item", itemObject);
                        postDetailOb.put("status", true);
                        postDetailOb.saveInBackground(new SaveCallback() {
                            @Override
                            public void done(ParseException e) {
