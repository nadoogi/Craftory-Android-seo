...
import cloud.scalabl.httpspg_app_q0nz5d8azjwlxxrweewghhzuexr7rc.anicast.adapters.CommercialTuesdayAdapter;
...
public class ArtworkTuesdayFragment extends Fragment {

    private static CommercialTuesdayAdapter commercialTuesdayAdapter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        commercialTuesdayAdapter = new CommercialTuesdayAdapter(getActivity(), requestManager);
        tues_list.setAdapter(commercialTuesdayAdapter);
                ...
                if(dy > 0) //check for scroll down
                {
                    ...
                    if(loading){
                        ...
                        if ( (visibleItemCount + pastVisibleItems) >= totalItemCount) {
                            ...
                            commercialTuesdayAdapter.loadNextPage();
