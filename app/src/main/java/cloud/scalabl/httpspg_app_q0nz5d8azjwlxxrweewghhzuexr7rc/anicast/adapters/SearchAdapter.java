...
public class SearchAdapter extends RecyclerParseAdapter {
    ...
    public SearchAdapter(Context context, final String orderBy, final Boolean ascending, final String queryString, String type, RequestManager requestManager, TextView result_count) {
        ...
        final ArrayList<String> notEqualQuery = new ArrayList<>();
        notEqualQuery.add("patron");
        notEqualQuery.add("seriese");
        ...
        this.queryFactory = new ParseQueryAdapter.QueryFactory<ParseObject>() {
            ...
            public ParseQuery<ParseObject> create() {
                ...
                if(queryString != null || queryString.length() == 0){
                    ...
                    nameQuery.whereNotContainedIn("post_type", notEqualQuery);
                    nameQuery.whereNotEqualTo("status", false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        functionPost.TimelineArtistPostAdapterBuilder( contentOb , holder, requestManager, "all");
    ...
    public int getItemCount() {
        ...
        result_count.setText( functionBase.makeComma(items.size()) + "개" );
