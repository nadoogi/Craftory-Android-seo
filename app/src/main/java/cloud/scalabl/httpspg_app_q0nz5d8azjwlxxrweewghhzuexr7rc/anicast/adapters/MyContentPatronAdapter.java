...
public class MyContentPatronAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyContentPatronAdapter( Context context, RequestManager requestManager) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        timelineView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_mycontent_patron, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        functionPost.TimelineArtistPatronAdapterWithDeleteBuilder( timelineOb, holder, requestManager, "mycontent", this);
