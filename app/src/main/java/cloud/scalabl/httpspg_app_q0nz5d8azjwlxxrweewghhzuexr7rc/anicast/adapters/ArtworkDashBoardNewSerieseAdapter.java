...
import cloud.scalabl.httpspg_app_q0nz5d8azjwlxxrweewghhzuexr7rc.anicast.viewHolders.ArtworkDashboardNewSerieseViewHolder;
...
public class ArtworkDashBoardNewSerieseAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ArtworkDashBoardNewSerieseAdapter(Context context, RequestManager requestManager) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_artwork_new_seriese, parent, false);

        return new ArtworkDashboardNewSerieseViewHolder(itemView);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        ImageView seriese_image = ((ArtworkDashboardNewSerieseViewHolder)holder).getSerieseImage();
        TextView title = ((ArtworkDashboardNewSerieseViewHolder)holder).getTitle();
        TextView description = ((ArtworkDashboardNewSerieseViewHolder)holder).getDescription();
        TextView nickname  = ((ArtworkDashboardNewSerieseViewHolder)holder).getNickname();
        LinearLayout profile_tag  = ((ArtworkDashboardNewSerieseViewHolder)holder).getProfileTag();
