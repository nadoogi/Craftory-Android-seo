...
public class TagItemMakerActivity extends AppCompatActivity {
        ...
        save_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(finalImage == null){
                    ...
                    ParseObject tagItemOb = new ParseObject("TagItem");
                    tagItemOb.put("tag", bodyString);
                    tagItemOb.put("image_cdn", finalImage);
                    tagItemOb.put("status", true);
                    tagItemOb.put("tag_array", tagString);
                    tagItemOb.put("type", "alchemy" );
                    tagItemOb.saveInBackground(new SaveCallback() {
                        @Override
