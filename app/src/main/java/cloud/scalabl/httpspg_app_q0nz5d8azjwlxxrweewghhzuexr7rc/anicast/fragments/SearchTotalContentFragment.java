...
public class SearchTotalContentFragment extends Fragment {
    ...
    public SearchTotalContentFragment(){
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        searchAdapter = new SearchAdapter( getActivity(), "createdAt", false , query, "total", requestManager, result_count);
