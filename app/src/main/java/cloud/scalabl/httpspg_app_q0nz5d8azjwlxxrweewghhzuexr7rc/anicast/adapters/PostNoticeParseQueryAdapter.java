...
public class PostNoticeParseQueryAdapter extends RecyclerParseAdapter {
    ...
    public PostNoticeParseQueryAdapter(Context context, RequestManager requestManager){
        super(context);
        ...
        this.queryFactory = new ParseQueryAdapter.QueryFactory<ParseObject>() {
            ...
            public ParseQuery<ParseObject> create() {
                ...
                query.whereEqualTo("from", "notice");
