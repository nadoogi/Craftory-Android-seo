...
public class PatronProductionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PatronProductionAdapter(Context context, RequestManager requestManager) {
