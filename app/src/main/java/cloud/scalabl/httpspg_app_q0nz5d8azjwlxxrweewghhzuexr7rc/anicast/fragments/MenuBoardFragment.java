...
import cloud.scalabl.httpspg_app_q0nz5d8azjwlxxrweewghhzuexr7rc.anicast.adapters.MenuRecyclerAdapter;
...
public class MenuBoardFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        MenuRecyclerAdapter menuRecyclerAdapter = new MenuRecyclerAdapter(getActivity(), requestManager);
