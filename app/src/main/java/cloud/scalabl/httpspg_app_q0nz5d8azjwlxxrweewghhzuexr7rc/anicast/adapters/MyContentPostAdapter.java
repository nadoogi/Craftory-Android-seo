...
public class MyContentPostAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyContentPostAdapter(AppCompatActivity activity, Context context, RequestManager requestManager) {
        ...
        this.queryFactory = new ParseQueryAdapter.QueryFactory<ParseObject>() {
            ...
            public ParseQuery<ParseObject> create() {
                ...
                query.whereNotContainedIn("post_type", querySet);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        functionPost.PostCMAdapterBuilder( timelineOb,  holder, requestManager, "cm" , this );
