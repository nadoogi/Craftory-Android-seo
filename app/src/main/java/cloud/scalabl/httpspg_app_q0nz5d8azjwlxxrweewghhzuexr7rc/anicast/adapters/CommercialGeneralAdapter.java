...
public class CommercialGeneralAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommercialGeneralAdapter(Context context, RequestManager requestManager) {
