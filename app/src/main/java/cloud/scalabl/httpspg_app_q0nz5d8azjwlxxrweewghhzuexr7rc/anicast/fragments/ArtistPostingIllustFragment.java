...
public class ArtistPostingIllustFragment extends Fragment implements FileOpenClickListener , ImageInfoClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_artist_post_illust, container, false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        save_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(images.size() == 0){
                    ...
                    params.put("lastAction", "albumSave");
        ...
        imageAdapter = new ImageUploadSelectorAdapter(getActivity(), savedImages, requestManager, illust_status_text);
        imageAdapter.setFileOpenClickListener(this);
        imageAdapter.setImageInfoClickListener(this);
                ...
                UploadCallback callback = new UploadCallback() {
                    ...
                    public void onSuccess(String requestId, Map resultData) {
                        ...
                        if(imageAdapter != null){
                            ...
                            imageAdapter = new ImageUploadSelectorAdapter(getActivity(), savedImages, requestManager, illust_status_text);
                            imageAdapter.setFileOpenClickListener(ArtistPostingIllustFragment.this);
                            imageAdapter.setImageInfoClickListener(ArtistPostingIllustFragment.this);
                            image_list.setAdapter(imageAdapter);
