...
import cloud.scalabl.httpspg_app_q0nz5d8azjwlxxrweewghhzuexr7rc.anicast.adapters.CommercialThusdayAdapter;
...
public class ArtworkThusdayFragment extends Fragment {

    private static CommercialThusdayAdapter commercialThusdayAdapter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        commercialThusdayAdapter = new CommercialThusdayAdapter(getActivity(), requestManager);
        tues_list.setAdapter(commercialThusdayAdapter);
                ...
                if(dy > 0) //check for scroll down
                {
                    ...
                    if(loading){
                        ...
                        if ( (visibleItemCount + pastVisibleItems) >= totalItemCount) {
                            ...
                            commercialThusdayAdapter.loadNextPage();
