...
public class RequestRankAdapter extends RecyclerParseAdapter {
    ...
    public RequestRankAdapter(Context context, RequestManager requestManager, String objectId) {
        ...
        this.queryFactory = new ParseQueryAdapter.QueryFactory<ParseObject>() {
            ...
            public ParseQuery<ParseObject> create() {
                ...
                query.include("user");
                query.orderByDescending("current_gifted_point");
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        final CircleImageView ranker_photo = ((RankingViewHolder)holder).getRankerPhoto();
        final TextView ranker_name = ((RankingViewHolder)holder).getRankingName();
        ...
        final ParseObject userOb = rankingOb.getParseObject("user");
        ...
        gifted_point.setText( String.valueOf( rankingOb.getInt("current_gifted_point") ) );
