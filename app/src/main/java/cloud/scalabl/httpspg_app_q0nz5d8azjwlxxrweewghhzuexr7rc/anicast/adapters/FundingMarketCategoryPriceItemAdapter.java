...
public class FundingMarketCategoryPriceItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FundingMarketCategoryPriceItemAdapter(Context context, RequestManager requestManager,  String category) {
