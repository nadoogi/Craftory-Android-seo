...
public class ArtistYoutubeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ArtistYoutubeAdapter(Context context, RequestManager requestManager) {

        ArtistYoutubeAdapter.requestManager = requestManager;
        ArtistYoutubeAdapter.context = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        timelineView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_timeline_item_youtube, parent, false);
