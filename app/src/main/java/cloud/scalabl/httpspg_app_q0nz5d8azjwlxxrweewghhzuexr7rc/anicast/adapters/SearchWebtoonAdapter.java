...
public class SearchWebtoonAdapter extends RecyclerParseAdapter {
    ...
    public SearchWebtoonAdapter(Context context, final String orderBy, final Boolean ascending, final String queryString, String type, RequestManager requestManager) {
