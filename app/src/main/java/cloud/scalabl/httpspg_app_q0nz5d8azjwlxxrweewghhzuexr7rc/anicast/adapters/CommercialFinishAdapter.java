...
public class CommercialFinishAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommercialFinishAdapter(Context context, RequestManager requestManager) {
