...
public class ArtworkDashBoardIllustRankingAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ArtworkDashBoardIllustRankingAdapter(Context context, RequestManager requestManager) {
