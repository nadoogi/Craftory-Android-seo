...
public class LibrarySubsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public LibrarySubsAdapter(Context context, RequestManager requestManager, final String type) {
        ...
        this.queryFactory = new ParseQueryAdapter.QueryFactory<ParseObject>() {
            ...
            public ParseQuery<ParseObject> create() {
                ...
                ParseQuery<ParseObject> query = currentUser.getRelation("subscribe_item").getQuery();
