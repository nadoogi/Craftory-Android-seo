...
public class SearchGifAdapter extends RecyclerParseAdapter {
    ...
    public SearchGifAdapter(Context context, final String orderBy, final Boolean ascending, final String queryString, String type, RequestManager requestManager) {
        ...
        this.queryFactory = new ParseQueryAdapter.QueryFactory<ParseObject>() {
            ...
            public ParseQuery<ParseObject> create() {
                ...
                nameQuery.whereEqualTo("type", "gif");
